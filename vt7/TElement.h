...
/**
    \file TElement.h
    \brief TElement luokan header
    \class TElement
    \brief TElement, IntElement & VariableElement luokat
*/
class TElement
{
    public:
        TElement(){};
        virtual ~TElement(){}
        virtual TElement * clone()const=0;
...
/**
    ...
    \var int val
*/
class IntElement : public TElement
{
    public:
        IntElement();
        IntElement(int v);
...
*/
class VariableElement : public TElement
{
    public:
        VariableElement();
...
typedef std::shared_ptr<TElement> element_ptr;
